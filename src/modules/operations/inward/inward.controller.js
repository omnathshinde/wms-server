...
import { Inward, Material, Site } from "#src/models/index.js";

import inwardQuery from "./inwardQuery.js";
...
export const bulkCreate = async (req, res) => {
	...
	if (existing.length > 0) {
		...
		return res.sendError(
			400,
			`Duplicate barcodes found: ${duplicateCodes.join(", ")}`,
		);
	}
	...
	if (validEntries.length === 0)
		return res.sendError(400, "No valid records to insert");
