import { Inward, Putaway, Shelf } from "#src/models/index.js";
...
export const create = async (req, res) => {
	...
	if (inward.qcStatus !== "Approved")
		return res.sendError(404, "QC is not approved yet");
	if (inward.shelfId === shelfId && inward.isPutAway)
		return res.sendError(
			400,
			"Material is already putaway at the selected location.",
		);
